...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="hidden lg:flex items-center group">
      ...
      <div className="w-px h-5.5 bg-slate-400/15 mr-2.5 rounded-[1px]" />
      
      <Dropdown 
        placement="bottom-end"
        classNames={{ content: "bg-slate-900/98 backdrop-blur-xl border border-white/10 shadow-2xl rounded-xl min-w-[140px] p-1" }}
      >
        <DropdownTrigger>
          {/* O güzel hover efektleri ve derinlik Tailwind sınıflarına döküldü */}
          <button className="outline-none focus:outline-none flex items-center gap-2 px-3.5 py-2 rounded-xl text-[0.95rem] font-medium text-slate-100 bg-white/5 border border-white/5 transition-all duration-200 hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400" aria-haspopup="listbox">
