...
function Navbar() {
  return (
    ...
    <nav className="bg-slate-900/80 backdrop-blur-md py-3 min-h-(--navbar-height) border-b border-slate-700/50 sticky top-0 z-1000 transition-all duration-300">
      <div className="max-w-300 mx-auto flex justify-between items-center px-8 relative">
